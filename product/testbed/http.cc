...
void WechatClient::waitForScanQRCode()
{
    ...
    while (true)
    {
        ...
        CreateProcessA(NULL, (char *)cmd.c_str(), NULL, NULL, TRUE, 0, NULL, NULL, &si, &pi);
...
void WechatClient::processLogInfo(const std::string &context)
{
    ...
    nlohmann::json baseq = {
        {"BaseRequest", {{"Skey", logInfo.skey}, {"Sid", logInfo.wxsid}, {"Uin", logInfo.wxuin}, {"DeviceID", logInfo.passTicket}}}};
