...
mkdir -p Release
cp "${MKL_DLL_PATH}/mkl_rt.dll" Release
cmake -G "Visual Studio 15 2017 Win64" -T "host=x64" ../ \
    ...
    -DUSE_MKLDNN=0 -DCMAKE_BUILD_TYPE=Release \
...
cp "${MKL_DLL_PATH}/mkl_rt.dll" "./mxnet/bin"
cp "${MKL_DLL_PATH}/mkl_intel_thread.dll" "./mxnet/bin"